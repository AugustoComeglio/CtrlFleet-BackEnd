...
ActiveRecord::Schema[7.1].define(version: 2023_09_11_231634) do
  ...
  create_table "documents", force: :cascade do |t|
    ...
    t.index ["vehicule_id"], name: "index_documents_on_vehicule_id"
  end

  create_table "enable_notification_type", force: :cascade do |t|
    t.boolean "enable"
    t.datetime "begin_at"
    t.datetime "end_at"
    t.bigint "notification_type_id"
    t.index ["notification_type_id"], name: "index_enable_notification_type_on_notification_type_id"
  end
  ...
  create_table "images", force: :cascade do |t|
    ...
    t.index ["vehicule_id"], name: "index_images_on_vehicule_id"
  end
