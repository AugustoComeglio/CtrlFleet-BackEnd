user_types_attributes = [
  { name: 'admin', enable_login: true },
  { name: 'conductor', enable_login: true },
  { name: 'administrador', enable_login: true },
  { name: 'mecanico', enable_login: true },
  { name: 'usuario', enable_login: true }
]
user_types_attributes.each { |attributes| UserType.find_or_create_by(attributes) }

user = User.find_or_initialize_by(email: 'ctrlfleet@gmail.com')
user.dni = '12123123'
