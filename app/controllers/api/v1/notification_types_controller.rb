    ...
    class NotificationTypesController < Api::BaseController
      ...
      def create
        ...
        if @notification_type.save
          ...
          render json: { message: @notification_type.errors.full_messages.join(', ') }, status: :not_found
        end
      end
      ...
      def show
        if @notification_type
          ...
          render json: { message: "Tipo de Notificacion con ID #{params[:id]} no encontrado" }, status: :not_found
        end
      end
